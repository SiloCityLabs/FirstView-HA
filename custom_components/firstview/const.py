...
CONF_SHOW_STUDENT_TRACKERS = "show_student_trackers"
CONF_SHOW_BUS_TRACKERS = "show_bus_trackers"
...
DEFAULT_SHOW_STUDENT_TRACKERS = True
DEFAULT_SHOW_BUS_TRACKERS = True
